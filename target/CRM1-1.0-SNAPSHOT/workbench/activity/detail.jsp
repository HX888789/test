...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success:function (data){
                    ...
                    if(data.success){
                        ...
                        html +='<font color="gray">市场活动</font> <font color="gray">-</font> <b>发传单</b> <small style="color: gray;"> '+data.ar.createTime+' 由'+data.ar.createBy+'</small>';
    ...
    //为更新按钮绑定事件
        $("#updateRemarkBtn").click(function (){
            var id =$("#remarkId").val();
            $.ajax({
                url:"workbench/activity/undateRemark.do",
                data:{
                    "id":id,
                ...
                //    修改是否成功 "ar" 备注的对象
                    if(data.success){
                    //    修改备注成功
                    //    更新div中相应的信息，需要更新的内容又noteContent和时间 人
	...
	function showRemarkList(){
		$.ajax({
			...
			//	请求回接受备注信息列表
				...
				html +='<font color="gray">市场活动</font> <font color="gray">-</font> <b>发传单</b> <small style="color: gray;" id="s'+n.id+'"> '+(n.editFlag==0?n.createTime:n.editTime)+' 由'+(n.editFlag==0?n.createBy:n.editBy)+'</small>';
				html +='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
...
$.ajax({
	...
	//	返回成功失败就可以
		if(data.success){
			//删除公共 删除列表
            //这种方法不行  使用的是before方法 每一次删除之后都会保留原有的数据
			// showRemarkList();
